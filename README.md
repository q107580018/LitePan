...
**Docker Compose 部署** · 镜像标签：`latest` 或指定 `v0.6.3`
...
如需固定当前版本，可将 Compose 中的镜像改为 `ghcr.io/q107580018/litepan:v0.6.3`。
...
[version-shield]: https://img.shields.io/badge/Version-v0.6.3-6C63FF?style=flat-square
